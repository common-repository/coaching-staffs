 ...
 *	3. mstw_cs_find_staff_position( ) - returns(first) staff position for the coach arg
 *---------------------------------------------------------*/
...
//---------------------------------------------------------------------------------
//	3. mstw_cs_find_staff_position: returns the array of option defaults
//		ARGUMENTS: coach CPT object
//		RETURNS  : staff position (CPT object) for coach arg 
//								(will be the first staff found for the coach)
//	
if ( !function_exists( 'mstw_cs_find_staff_position' ) ) {

	function mstw_cs_find_staff_position( $coachCPT ) {
		//mstw_log_msg( 'mstw_cs_find_staff_position:' );
		//mstw_log_msg( 'coach ID: ' . $coachCPT -> ID );
		
		$meta_query = array(
           'key'   => 'mstw_cs_position_coach',
           'value' => $coachCPT -> ID,
           'compare' => '=',
					 );
		...
		$posts = get_posts( array( 
							  ...
							  'post_type'   => 'staff_position',
								'meta_key'    => 'mstw_cs_position_coach',
								'meta_value'  => $coachCPT -> ID
								)
							);	
	...
	} //End: mstw_cs_find_staff_position( )
}
?>